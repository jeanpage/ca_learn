...
function nrelate_popular_popup_preview(NRELATE_POPULAR_SETTINGS_URL,wp_root_nr, NRELATE_POPULAR_PLUGIN_VERSION){
	...
	nr_href = 'http://api.nrelate.com/mpw_wp/' + NRELATE_POPULAR_PLUGIN_VERSION + '/nrelate_popup_content.php';
