 ...
 */
define( 'NRELATE_POPULAR_PLUGIN_VERSION', '0.52.7' );
...
define( 'NRELATE_POPULAR_ADMIN_VERSION', '0.05.3' );
...
define( 'NRELATE_POPULAR_PLUGIN_DIR', untrailingslashit(plugin_dir_path(__FILE__)) );
define( 'NRELATE_POPULAR_PLUGIN_URL', plugins_url( NRELATE_POPULAR_PLUGIN_NAME ) );
